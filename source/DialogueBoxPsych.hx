	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			case 'bf':
                ...
                char.animation.addByPrefix('br', 'BFbrrrrr', 24, true); //During dialogue
				char.animation.addByPrefix('angry', 'BFangry', 24, true); //During dialogue
                char.animation.addByPrefix('concerned', 'BFconcerned', 24, true); //During dialogue
				char.animation.addByPrefix('confident', 'BFconfident', 24, true); //During dialogue
                char.animation.addByPrefix('dumbfounded', 'BFdumbfounded', 24, true); //During dialogue
				char.animation.addByPrefix('confused', 'BFconfused', 24, true); //During dialogue
				char.animation.addByPrefix('relieved', 'BFrelieved', 24, true); //During dialogue
				char.animation.addByPrefix('scared', 'BFscared', 24, true); //During dialogue
				char.animation.addByPrefix('shocked', 'BFshocked', 24, true); //During dialogue
				char.animation.addByPrefix('worried', 'BFworried', 24, true); //During dialogue
                char.animation.addByPrefix('embarrassed', 'BFembarrassed', 24, true); //During dialogue
                char.animation.addByPrefix('excited', 'BFexcited', 24, true); //During dialogue
                char.animation.addByPrefix('happy', 'BFhappy', 24, true); //During dialogue
                char.animation.addByPrefix('sad', 'BFSad', 24, true); //During dialogue
                char.animation.addByPrefix('slightycheer', 'BFslightycheer', 24, true); //During dialogue
                char.animation.addByPrefix('thinking', 'BFthinking', 24, true); //During dialogue
                char.animation.addByPrefix('upset', 'BFupset', 24, true); //During dialogue
				char.animation.addByPrefix('GFtalkIdle', 'GFtalkloop copy', 24, true);
                char.animation.addByPrefix('GFangry', 'GFangryloop copy', 24, true);
                char.animation.addByPrefix('GFunamused', 'GFpissedloop copy', 24, true);
                char.animation.addByPrefix('GFconcerned', 'GFConcerned copy', 24, true);
                char.animation.addByPrefix('GFnormal', 'GFNormal copy', 24, true);
                char.animation.addByPrefix('GFxcited', 'GFexcited copy', 24, true);
				char.animation.addByPrefix('GFconfused', 'GFConfused copy', 24, true);
            ...
            case 'dad':
                char.frames = Paths.getSparrowAtlas('dialogue/dad_Dialogue'); //oppa gangnam style xddddd kill me
                char.animation.addByPrefix('talkIdle', 'DADtalkloop', 24, true);
                char.animation.addByPrefix('talk', 'DAD', 24, true);
                char.animation.addByPrefix('angryIdle', 'DADangry', 24, true);
                char.animation.addByPrefix('angry', 'DADangryloop', 24, true);
                char.animation.addByPrefix('unamusedIdle', 'DADpissed', 24, true);
                char.animation.addByPrefix('unamused', 'DADpissedloop', 24, true);
				char.animation.addByPrefix('smug', 'DADsmug', 24, true);
				char.animation.addByPrefix('tired-excited', 'Dad tired-excited', 24, true);
				char.animation.addByPrefix('tired', 'Dad tired', 24, true);
                char.y -= 140;

			case 'monster':
					char.frames = Paths.getSparrowAtlas('dialogue/Monster_Dialogue'); //oppa gangnam style xddddd kill me
					char.animation.addByPrefix('Monstertalk', 'Monstertalk', 24, true);
					char.y -= 140;
                
            case 'gf':
                char.frames = Paths.getSparrowAtlas('dialogue/GF_Dialogue'); //oppa gangnam style xddddd kill me
                char.animation.addByPrefix('talkIdle', 'GFtalkloop', 24, true);
                char.animation.addByPrefix('talk', 'GF', 24, true);
                char.animation.addByPrefix('angryIdle', 'GFangry', 24, true);
                char.animation.addByPrefix('angry', 'GFangryloop', 24, true);
                char.animation.addByPrefix('unamusedIdle', 'GFpissed', 24, true);
                char.animation.addByPrefix('unamused', 'GFpissedloop', 24, true);
                char.animation.addByPrefix('concerned', 'GFConcerned', 24, true);
                char.animation.addByPrefix('normal', 'GFNormal', 24, true);
                char.animation.addByPrefix('excited', 'GFexcited', 24, true);
                char.y -= 140;
                
            case 'pico':
                char.frames = Paths.getSparrowAtlas('dialogue/Pico_Dialogue'); //oppa gangnam style xddddd kill me
                char.animation.addByPrefix('talkIdle', 'PICOtalkloop', 24, true);
                char.animation.addByPrefix('talk', 'PICO', 24, true);
                char.animation.addByPrefix('angryIdle', 'PICOangry', 24, true);
                char.animation.addByPrefix('angry', 'PICOangryloop', 24, true);
                char.animation.addByPrefix('unamusedIdle', 'PICOpissed', 24, true);
				char.animation.addByPrefix('calmingdown', 'PICOcalmingdown', 24, true);
				char.animation.addByPrefix('StrangeSilhouette', 'PICOStrangeSilhouette', 24, true);
				char.animation.addByPrefix('smug', 'PICOsmug', 24, true);
				char.animation.addByPrefix('mockingly', 'PICOmockingly', 24, true);
				char.animation.addByPrefix('furious', 'PICOfurious', 24, true);
				char.animation.addByPrefix('emerging', 'PICOemerging', 24, true);
				char.animation.addByPrefix('tired', 'PICOtired', 24, true);
                char.animation.addByPrefix('unamused', 'PICOpissedloop', 24, true);
                char.y -= 140;
                
            case 'bump':
                char.frames = Paths.getSparrowAtlas('dialogue/Bump_Dialogue'); //oppa gangnam style xddddd kill me
                char.animation.addByPrefix('AngyBOTH', 'AngyBOTH', 24, true);
				char.animation.addByPrefix('ConfidentBOTH', 'ConfidentBOTH', 24, true);
                char.animation.addByPrefix('ConfidentSKID', 'ConfidentSKID', 24, true);
                char.animation.addByPrefix('MockinglyBOTH', 'MockinglyBOTH', 24, true);
                char.animation.addByPrefix('annoyedBOTH', 'annoyedBOTH', 24, true);
				char.animation.addByPrefix('annoyedPUMP', 'annoyedPUMP', 24, true);
                char.animation.addByPrefix('annoyedSKID', 'annoyedSKID', 24, true);
                char.y -= 140;
