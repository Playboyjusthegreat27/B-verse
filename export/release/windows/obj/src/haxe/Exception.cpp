...
HX_DEFINE_STACK_FRAME(_hx_pos_140d47d8a130dbdc_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",5,0x4398d12b)
HX_LOCAL_STACK_FRAME(_hx_pos_140d47d8a130dbdc_49_unwrap,"haxe.Exception","unwrap",0x6c26184a,"haxe.Exception.unwrap","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",49,0x4398d12b)
HX_LOCAL_STACK_FRAME(_hx_pos_140d47d8a130dbdc_75_get_native,"haxe.Exception","get_native",0xdd187087,"haxe.Exception.get_native","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",75,0x4398d12b)
HX_LOCAL_STACK_FRAME(_hx_pos_140d47d8a130dbdc_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",19,0x4398d12b)
HX_LOCAL_STACK_FRAME(_hx_pos_140d47d8a130dbdc_27_thrown,"haxe.Exception","thrown",0x8e12fc2f,"haxe.Exception.thrown","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",27,0x4398d12b)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_140d47d8a130dbdc_5_new)
...
bool Exception_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Exception_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_140d47d8a130dbdc_49_unwrap)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,unwrap,return )
 ...
 ::Dynamic Exception_obj::get_native(){
            	HX_STACKFRAME(&_hx_pos_140d47d8a130dbdc_75_get_native)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_native,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_140d47d8a130dbdc_19_caught)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Exception_obj,caught,return )
 ...
 ::Dynamic Exception_obj::thrown( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_140d47d8a130dbdc_27_thrown)
