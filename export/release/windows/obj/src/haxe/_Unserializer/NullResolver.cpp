...
HX_DEFINE_STACK_FRAME(_hx_pos_23ec09ed94dbb82d_484_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","E:\\Programs\\Haxe\\haxe\\std/haxe/Unserializer.hx",484,0x64b4bcdc)
HX_LOCAL_STACK_FRAME(_hx_pos_23ec09ed94dbb82d_487_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","E:\\Programs\\Haxe\\haxe\\std/haxe/Unserializer.hx",487,0x64b4bcdc)
HX_LOCAL_STACK_FRAME(_hx_pos_23ec09ed94dbb82d_490_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","E:\\Programs\\Haxe\\haxe\\std/haxe/Unserializer.hx",490,0x64b4bcdc)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_23ec09ed94dbb82d_484_new)
            	}
...
::hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_23ec09ed94dbb82d_487_resolveClass)
...
::hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_23ec09ed94dbb82d_490_resolveEnum)
