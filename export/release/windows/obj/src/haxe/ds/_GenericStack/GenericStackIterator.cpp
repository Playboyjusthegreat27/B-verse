...
HX_DEFINE_STACK_FRAME(_hx_pos_c4021bb41b8f78a8_78_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","E:\\Programs\\Haxe\\haxe\\std/haxe/ds/GenericStack.hx",78,0xf8800fe4)
HX_LOCAL_STACK_FRAME(_hx_pos_c4021bb41b8f78a8_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","E:\\Programs\\Haxe\\haxe\\std/haxe/ds/GenericStack.hx",68,0xf8800fe4)
HX_LOCAL_STACK_FRAME(_hx_pos_c4021bb41b8f78a8_71_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","E:\\Programs\\Haxe\\haxe\\std/haxe/ds/GenericStack.hx",71,0xf8800fe4)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_STACKFRAME(&_hx_pos_c4021bb41b8f78a8_78_new)
...
bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_c4021bb41b8f78a8_68_hasNext)
HXDLIN(  68)		return ::hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_c4021bb41b8f78a8_71_next)
