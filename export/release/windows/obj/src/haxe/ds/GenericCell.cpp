...
HX_DEFINE_STACK_FRAME(_hx_pos_b263332efcd90c3c_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","E:\\Programs\\Haxe\\haxe\\std/haxe/ds/GenericStack.hx",37,0xf8800fe4)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_b263332efcd90c3c_37_new)
