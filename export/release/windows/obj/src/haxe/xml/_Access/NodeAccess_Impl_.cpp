...
HX_LOCAL_STACK_FRAME(_hx_pos_67a3282ede4cb7fb_27_resolve,"haxe.xml._Access.NodeAccess_Impl_","resolve",0xc66a9d2e,"haxe.xml._Access.NodeAccess_Impl_.resolve","E:\\Programs\\Haxe\\haxe\\std/haxe/xml/Access.hx",27,0xe7aec54b)
namespace haxe{
namespace xml{
namespace _Access{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_67a3282ede4cb7fb_27_resolve)
