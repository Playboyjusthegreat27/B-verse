...
HXLINE( 137)			{
HXLINE( 137)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 137)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE(  91)			{
HXLINE(  91)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN(  91)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE( 109)			{
HXLINE( 109)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 109)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE(  96)			{
HXLINE(  96)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN(  96)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE( 126)			{
HXLINE( 126)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 126)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE(  78)			{
HXLINE(  78)				 ::flixel::FlxSprite _g = _hx_char;
HXDLIN(  78)				_g->set_y((_g->y - ( (Float)(140) )));
            			}
...
HXLINE( 192)			{
HXLINE( 192)				 ::flixel::FlxSprite _g1 = _hx_char;
HXDLIN( 192)				_g1->set_x((_g1->x + this->offsetPos));
            			}
...
HXLINE( 208)				{
HXLINE( 208)					 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 208)					Float _g1 = _g->x;
HXDLIN( 208)					_g->set_x((_g1 - (_hx_char->get_width() / ( (Float)(2) ))));
            				}
...
HXLINE( 231)			{
HXLINE( 231)				 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 231)				_g->set_alpha((_g->alpha + (((Float)0.5) * elapsed)));
            			}
...
HXLINE( 291)							::String _hx_switch_0 = this->charPositionList->__get(this->arrayPosition->__get(i));
            							if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 296)								{
HXLINE( 296)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 296)									_g->set_y((_g->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 293)								{
HXLINE( 293)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 293)									_g->set_x((_g->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 292)								goto _hx_goto_13;
            							...
            							if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 299)								{
HXLINE( 299)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 299)									_g->set_x((_g->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 298)								goto _hx_goto_13;
            							...
            							_hx_goto_13:;
HXLINE( 302)							{
HXLINE( 302)								 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 302)								_g->set_alpha((_g->alpha - (( (Float)(3) ) * elapsed)));
            							}
...
HXLINE( 310)								{
HXLINE( 310)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 310)									_g->set_y((_g->y - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 307)								{
HXLINE( 307)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 307)									_g->set_x((_g->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 313)								{
HXLINE( 313)									 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 313)									_g->set_x((_g->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 312)								goto _hx_goto_14;
            							...
            							_hx_goto_14:;
HXLINE( 316)							{
HXLINE( 316)								 ::flixel::FlxSprite _g = _hx_char;
HXDLIN( 316)								_g->set_alpha((_g->alpha + (( (Float)(3) ) * elapsed)));
            							}
...
HXLINE( 329)				{
HXLINE( 329)					 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 329)					_g->set_alpha((_g->alpha - (((Float)0.5) * elapsed)));
            				}
...
HXLINE( 339)						{
HXLINE( 339)							 ::flixel::FlxSprite _g = leChar;
HXDLIN( 339)							int _hx_tmp;
HXDLIN( 339)							if ((i == 1)) {
...
HXDLIN( 339)							_g->set_x((_g->x + (( (Float)((this->scrollSpeed * _hx_tmp)) ) * elapsed)));
            						}
HXLINE( 340)						{
HXLINE( 340)							 ::flixel::FlxSprite _g1 = leChar;
HXDLIN( 340)							_g1->set_alpha((_g1->alpha - (elapsed * ( (Float)(10) ))));
            						}
            					}
            				}
            			}
...
HXLINE( 422)			 ::flixel::math::FlxPoint _g = this->box->offset;
HXDLIN( 422)			_g->set_y((_g->y + 10));
            		}
            	}
