...
HXLINE(  46)				{
HXLINE(  46)					 ::flixel::math::FlxPoint _g = this->offset;
HXDLIN(  46)					_g->set_x((_g->x - ( (Float)(13) )));
            				}
HXLINE(  47)				{
HXLINE(  47)					 ::flixel::math::FlxPoint _g1 = this->offset;
HXDLIN(  47)					_g1->set_y((_g1->y - ( (Float)(13) )));
            				}
            			}
            		}
            	}
