...
HX_LOCAL_STACK_FRAME(_hx_pos_4abb795b407cd203_78_update,"ResetScoreSubState","update",0x9d03c883,"ResetScoreSubState.update","ResetScoreSubState.hx",78,0x6a59588a)
HX_LOCAL_STACK_FRAME(_hx_pos_4abb795b407cd203_110_updateOptions,"ResetScoreSubState","updateOptions",0xb4a4f91b,"ResetScoreSubState.updateOptions","ResetScoreSubState.hx",110,0x6a59588a)
...
HXLINE(  31)		if ((week != -1)) {
HXLINE(  32)			name = (HX_("Week ",8c,05,ec,5a) + ::WeekData_obj::getWeekNumber(week));
HXLINE(  33)			::String leName = ::WeekData_obj::weekResetName->__get(week);
HXLINE(  34)			if (::hx::IsNotNull( leName )) {
HXLINE(  35)				name = leName;
            			}
            		}
HXLINE(  38)		name = (name + ((HX_(" (",08,1c,00,00) + ::CoolUtil_obj::difficultyStuff->__get(difficulty)->__GetItem(0)) + HX_(")?",f6,23,00,00)));
HXLINE(  40)		this->bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE(  41)		this->bg->set_alpha(( (Float)(0) ));
HXLINE(  42)		this->bg->scrollFactor->set(null(),null());
HXLINE(  43)		this->add(this->bg);
HXLINE(  45)		Float tooLong;
HXDLIN(  45)		if ((name.length > 18)) {
HXLINE(  45)			tooLong = ((Float)0.8);
            		}
            		else {
HXLINE(  45)			tooLong = ( (Float)(1) );
            		}
HXLINE(  46)		 ::Alphabet text =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(180) ),HX_("Reset the score of",c5,93,fa,2d),true,null(),null(),null());
HXLINE(  47)		text->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  48)		this->alphabetArray->push(text);
HXLINE(  49)		text->set_alpha(( (Float)(0) ));
HXLINE(  50)		this->add(text);
HXLINE(  51)		 ::Alphabet text1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text->y + 90),name,true,false,((Float)0.05),tooLong);
HXLINE(  52)		text1->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  53)		if ((week == -1)) {
HXLINE(  53)			 ::Alphabet _g = text1;
HXDLIN(  53)			_g->set_x((_g->x + (( (Float)(60) ) * tooLong)));
            		}
HXLINE(  54)		this->alphabetArray->push(text1);
HXLINE(  55)		text1->set_alpha(( (Float)(0) ));
HXLINE(  56)		this->add(text1);
HXLINE(  57)		if ((week == -1)) {
HXLINE(  58)			this->icon =  ::HealthIcon_obj::__alloc( HX_CTX ,character,null());
HXLINE(  59)			 ::HealthIcon _hx_tmp = this->icon;
HXDLIN(  59)			_hx_tmp->setGraphicSize(::Std_obj::_hx_int((this->icon->get_width() * tooLong)),null());
HXLINE(  60)			this->icon->updateHitbox();
HXLINE(  61)			 ::HealthIcon _hx_tmp1 = this->icon;
HXDLIN(  61)			Float text = text1->x;
HXDLIN(  61)			Float _hx_tmp2 = ((text - this->icon->get_width()) + (( (Float)(10) ) * tooLong));
HXDLIN(  61)			_hx_tmp1->setPosition(_hx_tmp2,(text1->y - ( (Float)(30) )));
HXLINE(  62)			this->icon->set_alpha(( (Float)(0) ));
HXLINE(  63)			this->add(this->icon);
            		}
HXLINE(  66)		this->yesText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text1->y + 150),HX_("Yes",07,e1,43,00),true,null(),null(),null());
HXLINE(  67)		this->yesText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  68)		{
HXLINE(  68)			 ::Alphabet _g = this->yesText;
HXDLIN(  68)			_g->set_x((_g->x - ( (Float)(200) )));
            		}
HXLINE(  69)		this->add(this->yesText);
HXLINE(  70)		this->noText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(text1->y + 150),HX_("No",61,44,00,00),true,null(),null(),null());
HXLINE(  71)		this->noText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  72)		{
HXLINE(  72)			 ::Alphabet _g1 = this->noText;
HXDLIN(  72)			_g1->set_x((_g1->x + 200));
            		}
HXLINE(  73)		this->add(this->noText);
...
void ResetScoreSubState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_4abb795b407cd203_78_update)
HXLINE(  79)		{
HXLINE(  79)			 ::flixel::FlxSprite _g = this->bg;
HXDLIN(  79)			_g->set_alpha((_g->alpha + (elapsed * ((Float)1.5))));
            		}
...
HXLINE(  82)		{
HXLINE(  82)			int _g1 = 0;
HXDLIN(  82)			int _g2 = this->alphabetArray->length;
HXDLIN(  82)			while((_g1 < _g2)){
HXLINE(  82)				_g1 = (_g1 + 1);
HXDLIN(  82)				int i = (_g1 - 1);
HXLINE(  83)				 ::Alphabet spr = this->alphabetArray->__get(i).StaticCast<  ::Alphabet >();
HXLINE(  84)				{
HXLINE(  84)					 ::Alphabet _g = spr;
HXDLIN(  84)					_g->set_alpha((_g->alpha + (elapsed * ((Float)2.5))));
            				}
            			}
            		}
HXLINE(  86)		if ((this->week == -1)) {
HXLINE(  86)			 ::HealthIcon _g = this->icon;
HXDLIN(  86)			_g->set_alpha((_g->alpha + (elapsed * ((Float)2.5))));
            		}
HXLINE(  88)		bool _hx_tmp;
HXDLIN(  88)		if (!(::PlayerSettings_obj::player1->controls->_ui_leftP->check())) {
HXLINE(  88)			_hx_tmp = ::PlayerSettings_obj::player1->controls->_ui_rightP->check();
            		}
            		else {
...
HXDLIN(  89)			_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),1,null(),null(),null(),null());
...
HXDLIN(  94)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
HXLINE(  95)			this->close();
            		}
            		else {
HXLINE(  96)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  97)				if (this->onYes) {
HXLINE(  98)					if ((this->week == -1)) {
HXLINE(  99)						::Highscore_obj::resetSong(this->song,this->difficulty);
            					}
            					else {
HXLINE( 101)						::Highscore_obj::resetWeek(this->week,this->difficulty);
            					}
            				}
HXLINE( 104)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 104)				_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
void ResetScoreSubState_obj::updateOptions(){
            	HX_STACKFRAME(&_hx_pos_4abb795b407cd203_110_updateOptions)
HXLINE( 111)		::Array< Float > scales = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_4,2);
HXLINE( 112)		::Array< Float > alphas = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_5,2);
...
HXLINE( 116)		this->yesText->scale->set(scales->__get(confirmInt),scales->__get(confirmInt));
HXLINE( 117)		this->noText->set_alpha(alphas->__get((1 - confirmInt)));
HXLINE( 118)		this->noText->scale->set(scales->__get((1 - confirmInt)),scales->__get((1 - confirmInt)));
