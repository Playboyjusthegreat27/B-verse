...
HX_LOCAL_STACK_FRAME(_hx_pos_a2a86a23843e0eb5_29_startFlashing,"MenuItem","startFlashing",0xa64b34b8,"MenuItem.startFlashing","MenuItem.hx",29,0x14bda78c)
HX_LOCAL_STACK_FRAME(_hx_pos_a2a86a23843e0eb5_39_update,"MenuItem","update",0x1808c085,"MenuItem.update","MenuItem.hx",39,0x14bda78c)
...
HXLINE(  36)		this->fakeFramerate = ::Math_obj::round(((( (Float)(1) ) / ::flixel::FlxG_obj::elapsed) / ( (Float)(10) )));
HXLINE(  25)		this->isFlashing = false;
...
HXDLIN(  19)		::String key = (HX_("storymenu/week",0f,e3,c9,3d) + ::WeekData_obj::getWeekNumber(weekNum));
HXDLIN(  19)		::String library = null();
HXDLIN(  19)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN(  19)		 ::Dynamic _hx_tmp1;
HXDLIN(  19)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  19)			_hx_tmp1 = imageToReturn;
            		}
            		else {
HXLINE(  19)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN(  19)		this->week = _hx_tmp->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE(  21)		this->week->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  22)		this->add(this->week);
            	}
...
void MenuItem_obj::startFlashing(){
            	HX_STACKFRAME(&_hx_pos_a2a86a23843e0eb5_29_startFlashing)
HXDLIN(  29)		this->isFlashing = true;
            	}
...
void MenuItem_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a2a86a23843e0eb5_39_update)
HXLINE(  40)		this->super::update(elapsed);
HXLINE(  41)		Float a = this->y;
HXDLIN(  41)		Float b = ((this->targetY * ( (Float)(120) )) + 480);
HXDLIN(  41)		this->set_y((a + (::CoolUtil_obj::boundTo((elapsed * ((Float)10.2)),( (Float)(0) ),( (Float)(1) )) * (b - a))));
HXLINE(  43)		if (this->isFlashing) {
HXLINE(  44)			 ::MenuItem _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
