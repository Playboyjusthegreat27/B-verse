...
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_50_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",50,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_118_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",118,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_158_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",158,0x643782c6)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_194_htmlUnescape,"StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",194,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_222_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",222,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_252_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",252,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_279_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",279,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_297_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",297,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_322_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",322,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_350_trim,"StringTools","trim",0x2908d066,"StringTools.trim","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",350,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_366_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",366,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_425_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",425,0x643782c6)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff18d41df564199_435_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","E:\\Programs\\Haxe\\haxe\\std/StringTools.hx",435,0x643782c6)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_50_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_118_urlDecode)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_GC_STACKFRAME(&_hx_pos_1ff18d41df564199_158_htmlEscape)
...
::String StringTools_obj::htmlUnescape(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_194_htmlUnescape)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_222_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_252_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_279_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_297_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_322_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_350_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_1ff18d41df564199_366_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_425_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_1ff18d41df564199_435_hex)
