...
HXLINE( 414)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 414)			_g->set_y((_g->y - (( (Float)(20) ) * this->textSize)));
HXDLIN( 414)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("(",28,00,00,00)) ){
HXLINE( 419)			{
HXLINE( 419)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 419)				_g->set_x((_g->x - (( (Float)(65) ) * this->textSize)));
            			}
HXLINE( 420)			{
HXLINE( 420)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 420)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
...
HXLINE( 423)			{
HXLINE( 423)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 423)				_g->set_x((_g->x - (( (Float)(20) ) / this->textSize)));
            			}
HXLINE( 424)			{
HXLINE( 424)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 424)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
...
HXLINE( 416)			{
HXLINE( 416)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 416)				_g->set_x((_g->x - (( (Float)(35) ) - (( (Float)(90) ) * (((Float)1.0) - this->textSize)))));
            			}
HXLINE( 417)			{
HXLINE( 417)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 417)				_g1->set_y((_g1->y - (( (Float)(16) ) * this->textSize)));
            			}
...
HXLINE( 442)		{
HXLINE( 442)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 442)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXLINE( 453)		{
HXLINE( 453)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 453)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXLINE( 466)			{
HXLINE( 466)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 466)				_g->set_y((_g->y - ( (Float)(50) )));
            			}
...
HXLINE( 481)		{
HXLINE( 481)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 481)			_g->set_y((_g->y + (this->row * 60)));
            		}
HXLINE( 482)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 485)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 485)			_g->set_y((_g->y - ( (Float)(20) )));
HXDLIN( 485)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 487)			{
HXLINE( 487)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 487)				_g->set_x((_g->x - (( (Float)(35) ) - (( (Float)(90) ) * (((Float)1.0) - this->textSize)))));
            			}
HXLINE( 488)			{
HXLINE( 488)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 488)				_g1->set_y((_g1->y - ( (Float)(16) )));
            			}
