...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_28_create,"MusicBeatState","create",0x5e9058f4,"MusicBeatState.create","MusicBeatState.hx",28,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_44_update,"MusicBeatState","update",0x69867801,"MusicBeatState.update","MusicBeatState.hx",44,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_59_updateBeat,"MusicBeatState","updateBeat",0x79761a17,"MusicBeatState.updateBeat","MusicBeatState.hx",59,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_63_updateCurStep,"MusicBeatState","updateCurStep",0xd6ad7aeb,"MusicBeatState.updateCurStep","MusicBeatState.hx",63,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_113_stepHit,"MusicBeatState","stepHit",0xcf94756f,"MusicBeatState.stepHit","MusicBeatState.hx",113,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_118_beatHit,"MusicBeatState","beatHit",0xc257b185,"MusicBeatState.beatHit","MusicBeatState.hx",118,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_78_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",78,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_86_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",86,0xa1b2f108)
...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_102_resetState,"MusicBeatState","resetState",0xec54fbba,"MusicBeatState.resetState","MusicBeatState.hx",102,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_105_getState,"MusicBeatState","getState",0x1dfde593,"MusicBeatState.getState","MusicBeatState.hx",105,0xa1b2f108)
...
void MusicBeatState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_28_create)
HXLINE(  30)		if (!(::ClientPrefs_obj::imagesPersist)) {
HXLINE(  31)			::Paths_obj::customImagesLoaded->clear();
            		}
HXLINE(  34)		this->super::create();
HXLINE(  37)		if (!(::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut)) {
HXLINE(  38)			this->openSubState( ::CustomFadeTransition_obj::__alloc( HX_CTX ,( (Float)(1) ),true));
            		}
HXLINE(  40)		::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut = false;
            	}


void MusicBeatState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_44_update)
HXLINE(  46)		int oldStep = this->curStep;
HXLINE(  48)		this->updateCurStep();
HXLINE(  49)		this->updateBeat();
HXLINE(  51)		bool _hx_tmp;
HXDLIN(  51)		if ((oldStep != this->curStep)) {
HXLINE(  51)			_hx_tmp = (this->curStep > 0);
            		}
            		else {
...
void MusicBeatState_obj::updateBeat(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_59_updateBeat)
HXDLIN(  59)		this->curBeat = ::Math_obj::floor((( (Float)(this->curStep) ) / ( (Float)(4) )));
            	}
...
void MusicBeatState_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_63_updateCurStep)
HXLINE(  64)		 ::Dynamic lastChange =  ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("stepTime",79,75,25,a0),0)
            			->setFixed(1,HX_("bpm",df,be,4a,00),( (Float)(0) ))
            			->setFixed(2,HX_("songTime",82,2a,d5,3a),( (Float)(0) )));
HXLINE(  69)		{
HXLINE(  69)			int _g = 0;
HXDLIN(  69)			int _g1 = ::Conductor_obj::bpmChangeMap->length;
HXDLIN(  69)			while((_g < _g1)){
HXLINE(  69)				_g = (_g + 1);
HXDLIN(  69)				int i = (_g - 1);
HXLINE(  71)				if (::hx::IsGreaterEq( ::Conductor_obj::songPosition,::Conductor_obj::bpmChangeMap->__get(i)->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic) )) {
HXLINE(  72)					lastChange = ::Conductor_obj::bpmChangeMap->__get(i);
            				}
            			}
            		}
HXLINE(  75)		this->curStep = ( (int)((lastChange->__Field(HX_("stepTime",79,75,25,a0),::hx::paccDynamic) + ::Math_obj::floor((((::Conductor_obj::songPosition - ( (Float)(::ClientPrefs_obj::noteOffset) )) - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ::Conductor_obj::stepCrochet)))) );
            	}
...
void MusicBeatState_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_113_stepHit)
HXDLIN( 113)		if ((::hx::Mod(this->curStep,4) == 0)) {
HXLINE( 114)			this->beatHit();
            		}
            	}
...
void MusicBeatState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_118_beatHit)
            	}
...
void MusicBeatState_obj::switchState( ::flixel::FlxState nextState){
            	HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_78_switchState)
HXLINE(  80)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE(  81)		 ::MusicBeatState leState = ( ( ::MusicBeatState)(curState) );
HXLINE(  82)		if (!(::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn)) {
HXLINE(  83)			leState->openSubState( ::CustomFadeTransition_obj::__alloc( HX_CTX ,((Float)0.7),false));
HXLINE(  84)			if (::hx::IsEq( nextState,::flixel::FlxG_obj::game->_state )) {
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_86_switchState)
HXLINE(  86)					 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
...
HXLINE(  85)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_0());
            			}
            			else {
...
HXLINE(  91)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  91)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE(  90)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_1(nextState));
            			}
HXLINE(  95)			return;
            		}
HXLINE(  97)		::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = false;
...
void MusicBeatState_obj::resetState(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_102_resetState)
HXDLIN( 102)		::MusicBeatState_obj::switchState(::flixel::FlxG_obj::game->_state);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(MusicBeatState_obj,resetState,(void))
 ...
 ::MusicBeatState MusicBeatState_obj::getState(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_105_getState)
HXLINE( 106)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE( 107)		 ::MusicBeatState leState = ( ( ::MusicBeatState)(curState) );
HXLINE( 108)		return leState;
            	}
