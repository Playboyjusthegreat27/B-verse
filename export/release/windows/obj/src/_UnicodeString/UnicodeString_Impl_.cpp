...
HX_LOCAL_STACK_FRAME(_hx_pos_3f09695e3e929858_167_charCodeAt,"_UnicodeString.UnicodeString_Impl_","charCodeAt",0xd9768435,"_UnicodeString.UnicodeString_Impl_.charCodeAt","E:\\Programs\\Haxe\\haxe\\std/UnicodeString.hx",167,0x7b701f82)
HX_LOCAL_STACK_FRAME(_hx_pos_3f09695e3e929858_315_substr,"_UnicodeString.UnicodeString_Impl_","substr",0xd1a740f0,"_UnicodeString.UnicodeString_Impl_.substr","E:\\Programs\\Haxe\\haxe\\std/UnicodeString.hx",315,0x7b701f82)
HX_LOCAL_STACK_FRAME(_hx_pos_3f09695e3e929858_415_get_length,"_UnicodeString.UnicodeString_Impl_","get_length",0x33b0a1ee,"_UnicodeString.UnicodeString_Impl_.get_length","E:\\Programs\\Haxe\\haxe\\std/UnicodeString.hx",415,0x7b701f82)
...
bool UnicodeString_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic UnicodeString_Impl__obj::charCodeAt(::String this1,int index){
            	HX_STACKFRAME(&_hx_pos_3f09695e3e929858_167_charCodeAt)
...
::String UnicodeString_Impl__obj::substr(::String this1,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_3f09695e3e929858_315_substr)
HXLINE( 316)		if ((pos < 0)) {
...
int UnicodeString_Impl__obj::get_length(::String this1){
            	HX_STACKFRAME(&_hx_pos_3f09695e3e929858_415_get_length)
HXLINE( 416)		int l = 0;
HXLINE( 417)		{
