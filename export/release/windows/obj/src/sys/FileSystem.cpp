...
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",31,0x37f4b5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0x37f4b5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",75,0x37f4b5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",78,0x37f4b5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",93,0x37f4b5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3a90d63cfe320a96_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/FileSystem.hx",101,0x37f4b5a4)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_93_deleteFile)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_3a90d63cfe320a96_101_readDirectory)
