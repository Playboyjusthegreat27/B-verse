...
HX_DEFINE_STACK_FRAME(_hx_pos_2032f8eb0901df5f_61_new,"sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",61,0x9acbdf49)
HX_LOCAL_STACK_FRAME(_hx_pos_2032f8eb0901df5f_67_readByte,"sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",67,0x9acbdf49)
HX_LOCAL_STACK_FRAME(_hx_pos_2032f8eb0901df5f_73_readBytes,"sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",73,0x9acbdf49)
namespace sys{
namespace io{
namespace _Process{

void Stdout_obj::__construct( ::Dynamic p,bool out){
            	HX_STACKFRAME(&_hx_pos_2032f8eb0901df5f_61_new)
HXLINE(  62)		this->p = p;
...
int Stdout_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_2032f8eb0901df5f_67_readByte)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_2032f8eb0901df5f_73_readBytes)
