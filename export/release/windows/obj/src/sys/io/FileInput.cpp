...
HX_DEFINE_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_33_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",33,0xbd5871aa)
HX_LOCAL_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_37_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",37,0xbd5871aa)
HX_LOCAL_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_48_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",48,0xbd5871aa)
HX_LOCAL_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_58_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",58,0xbd5871aa)
HX_LOCAL_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_64_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",64,0xbd5871aa)
HX_LOCAL_STACK_FRAME(_hx_pos_f9bd6b0123d3b94f_68_tell,"sys.io.FileInput","tell",0x38812eb8,"sys.io.FileInput.tell","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/FileInput.hx",68,0xbd5871aa)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_33_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_37_readByte)
HXDLIN(  37)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_48_readBytes)
HXDLIN(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_58_close)
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_64_seek)
...
int FileInput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_f9bd6b0123d3b94f_68_tell)
