...
HX_LOCAL_STACK_FRAME(_hx_pos_e0416bf186d087ce_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",30,0x6004f5e8)
HX_LOCAL_STACK_FRAME(_hx_pos_e0416bf186d087ce_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",33,0x6004f5e8)
HX_LOCAL_STACK_FRAME(_hx_pos_e0416bf186d087ce_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",44,0x6004f5e8)
HX_LOCAL_STACK_FRAME(_hx_pos_e0416bf186d087ce_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",51,0x6004f5e8)
HX_LOCAL_STACK_FRAME(_hx_pos_e0416bf186d087ce_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","E:\\Programs\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",55,0x6004f5e8)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_e0416bf186d087ce_30_getContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_e0416bf186d087ce_33_getBytes)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_e0416bf186d087ce_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,saveBytes,(void))
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_e0416bf186d087ce_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_e0416bf186d087ce_55_write)
