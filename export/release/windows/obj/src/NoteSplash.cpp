...
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_64_loadAnims,"NoteSplash","loadAnims",0x63686ba7,"NoteSplash.loadAnims","NoteSplash.hx",64,0x3ec9e545)
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_74_update,"NoteSplash","update",0x2e98cebe,"NoteSplash.update","NoteSplash.hx",74,0x3ec9e545)
...
HXLINE(  24)		this->setupNoteSplash(x,y,note,null());
...
void NoteSplash_obj::setupNoteSplash(Float x,Float y,::hx::Null< int >  __o_note,::hx::Null< int >  __o_noteType){
            		int note = __o_note.Default(0);
            		int noteType = __o_noteType.Default(0);
...
HXLINE(  32)		if ((this->lastNoteType != noteType)) {
HXLINE(  33)			::String skin = HX_("noteSplashes",a7,57,29,8d);
...
HXLINE(  34)				skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
            			}
HXLINE(  36)			if ((noteType == 3)) {
HXLINE(  38)				this->loadAnims((HX_("HURT",0f,24,d8,2f) + skin));
            			}
            			else {
HXLINE(  41)				this->loadAnims(skin);
            			}
HXLINE(  43)			this->lastNoteType = noteType;
            		}
HXLINE(  46)		if ((noteType == 3)) {
HXLINE(  48)			this->colorSwap->set_hue(( (Float)(0) ));
HXLINE(  49)			this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE(  50)			this->colorSwap->set_brightness(( (Float)(0) ));
            		}
            		else {
HXLINE(  53)			this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(note,4)).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE(  54)			this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(note,4)).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE(  55)			this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(note,4)).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
            		}
HXLINE(  57)		this->offset->set(10,10);
HXLINE(  59)		int animNum = ::flixel::FlxG_obj::random->_hx_int(1,2,null());
HXLINE(  60)		this->animation->play((((HX_("note",f2,17,0a,49) + note) + HX_("-",2d,00,00,00)) + animNum),true,null(),null());
HXLINE(  61)		 ::flixel::animation::FlxAnimation _hx_tmp = this->animation->_curAnim;
HXDLIN(  61)		_hx_tmp->set_frameRate(( (Float)((24 + ::flixel::FlxG_obj::random->_hx_int(-2,2,null()))) ));
            	}
...
void NoteSplash_obj::loadAnims(::String skin){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_64_loadAnims)
HXLINE(  65)		::String library = null();
HXDLIN(  65)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(skin);
HXDLIN(  65)		bool xmlExists = false;
HXDLIN(  65)		if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE(  65)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(skin);
HXDLIN(  65)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  65)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE(  65)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
            		}
HXDLIN(  65)		::String _hx_tmp1;
HXDLIN(  65)		if (xmlExists) {
HXLINE(  65)			_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  65)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  65)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE(  66)		{
HXLINE(  66)			{
HXLINE(  67)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 1),(HX_("note splash blue ",bb,a1,1a,b9) + 1),24,false,null(),null());
HXLINE(  68)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 1),(HX_("note splash green ",e8,04,d0,a7) + 1),24,false,null(),null());
HXLINE(  69)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 1),(HX_("note splash purple ",19,23,01,5b) + 1),24,false,null(),null());
HXLINE(  70)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 1),(HX_("note splash red ",da,d5,64,cd) + 1),24,false,null(),null());
            			}
HXLINE(  66)			{
HXLINE(  67)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 2),(HX_("note splash blue ",bb,a1,1a,b9) + 2),24,false,null(),null());
HXLINE(  68)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 2),(HX_("note splash green ",e8,04,d0,a7) + 2),24,false,null(),null());
HXLINE(  69)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 2),(HX_("note splash purple ",19,23,01,5b) + 2),24,false,null(),null());
HXLINE(  70)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 2),(HX_("note splash red ",da,d5,64,cd) + 2),24,false,null(),null());
            			}
            		}
            	}
...
void NoteSplash_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_74_update)
HXLINE(  75)		if (this->animation->_curAnim->finished) {
HXLINE(  75)			this->kill();
            		}
...
void NoteSplash_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(lastNoteType,"lastNoteType");
...
void NoteSplash_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(lastNoteType,"lastNoteType");
...
::hx::Val NoteSplash_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"lastNoteType") ) { return ::hx::Val( lastNoteType ); }
		break;
	case 15:
...
::hx::Val NoteSplash_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"lastNoteType") ) { lastNoteType=inValue.Cast< int >(); return inValue; }
	}
...
void NoteSplash_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("lastNoteType",42,24,ce,bd));
...
static ::hx::StorageInfo NoteSplash_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(NoteSplash_obj,lastNoteType),HX_("lastNoteType",42,24,ce,bd)},
	{ ::hx::fsUnknown, 0, null()}
};
