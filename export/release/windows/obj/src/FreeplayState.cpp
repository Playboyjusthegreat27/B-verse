...
HXLINE( 208)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 208)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXLINE( 329)		 ::FreeplayState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 392)		{
HXLINE( 392)			 ::flixel::text::FlxText _g = this->diffText;
HXDLIN( 392)			Float _g1 = _g->x;
HXDLIN( 392)			_g->set_x((_g1 - (this->diffText->get_width() / ( (Float)(2) ))));
            		}
            	}
