...
class HXCPP_CLASS_ATTRIBUTES StrumNote_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,int leData);
		...
		static ::hx::ObjectPtr< StrumNote_obj > __new(Float x,Float y,int leData);
		static ::hx::ObjectPtr< StrumNote_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,int leData);
