...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_27_new)
...
HXLINE(  39)		( ( ::Song)(__this) )->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  38)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  37)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  35)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  32)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  43)		( ( ::Song)(__this) )->song = song;
HXLINE(  44)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  45)		( ( ::Song)(__this) )->bpm = bpm;
            	}
