...
class HXCPP_CLASS_ATTRIBUTES AttachedText_obj : public  ::Alphabet_obj
{
	...
	public:
		...
		void __construct(::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold);
		...
		static ::hx::ObjectPtr< AttachedText_obj > __new(::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold);
		static ::hx::ObjectPtr< AttachedText_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold);
