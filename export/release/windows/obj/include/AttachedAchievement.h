...
class HXCPP_CLASS_ATTRIBUTES AttachedAchievement_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id);
		...
		static ::hx::ObjectPtr< AttachedAchievement_obj > __new(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id);
		static ::hx::ObjectPtr< AttachedAchievement_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id);
