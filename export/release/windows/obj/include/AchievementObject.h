...
class HXCPP_CLASS_ATTRIBUTES AchievementObject_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		void __construct(int id, ::flixel::FlxCamera camera);
		...
		static ::hx::ObjectPtr< AchievementObject_obj > __new(int id, ::flixel::FlxCamera camera);
		static ::hx::ObjectPtr< AchievementObject_obj > __alloc(::hx::Ctx *_hx_ctx,int id, ::flixel::FlxCamera camera);
