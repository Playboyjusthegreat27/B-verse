...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_24_difficultyString,"CoolUtil","difficultyString",0x7da345af,"CoolUtil.difficultyString","CoolUtil.hx",24,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_27_boundTo,"CoolUtil","boundTo",0xe1951d76,"CoolUtil.boundTo","CoolUtil.hx",27,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_35_coolTextFile,"CoolUtil","coolTextFile",0xa6086875,"CoolUtil.coolTextFile","CoolUtil.hx",35,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_51_numberArray,"CoolUtil","numberArray",0x9e0008ad,"CoolUtil.numberArray","CoolUtil.hx",51,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_62_precacheSound,"CoolUtil","precacheSound",0x516888ed,"CoolUtil.precacheSound","CoolUtil.hx",62,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_71_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",71,0x9f143813)
...
::String CoolUtil_obj::difficultyString(){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_24_difficultyString)
HXDLIN(  24)		return ( (::String)(::CoolUtil_obj::difficultyStuff->__get(::PlayState_obj::storyDifficulty)->__GetItem(0)->__Field(HX_("toUpperCase",37,30,fd,38),::hx::paccDynamic)()) );
            	}
...
Float CoolUtil_obj::boundTo(Float value,Float min,Float max){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_27_boundTo)
HXLINE(  28)		Float newValue = value;
HXLINE(  29)		if ((newValue < min)) {
HXLINE(  29)			newValue = min;
            		}
            		else {
HXLINE(  30)			if ((newValue > max)) {
HXLINE(  30)				newValue = max;
            			}
            		}
HXLINE(  31)		return newValue;
            	}
...
::Array< ::String > CoolUtil_obj::coolTextFile(::String path){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_35_coolTextFile)
HXLINE(  37)		::Array< ::String > daList = ::StringTools_obj::trim(::sys::io::File_obj::getContent(path)).split(HX_("\n",0a,00,00,00));
HXLINE(  42)		{
HXLINE(  42)			int _g = 0;
...
::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            	...
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_51_numberArray)
HXLINE(  52)		::Array< int > dumbArray = ::Array_obj< int >::__new(0);
HXLINE(  53)		{
HXLINE(  53)			int _g = ( (int)(min) );
HXDLIN(  53)			int _g1 = max;
HXDLIN(  53)			while((_g < _g1)){
HXLINE(  53)				_g = (_g + 1);
HXDLIN(  53)				int i = (_g - 1);
HXLINE(  55)				dumbArray->push(i);
            			}
            		}
HXLINE(  57)		return dumbArray;
            	}
...
void CoolUtil_obj::precacheSound(::String sound,::String library){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_62_precacheSound)
HXDLIN(  62)		::Dynamic _hx_tmp = ::openfl::utils::Assets_obj::cache;
HXDLIN(  62)		if (!(::openfl::utils::IAssetCache_obj::hasSound(_hx_tmp,::Paths_obj::sound(sound,library)))) {
HXLINE(  63)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
HXDLIN(  63)			::String EmbeddedSound = ::Paths_obj::sound(sound,library);
HXDLIN(  63)			bool _hx_tmp;
HXDLIN(  63)			if (!(::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)))) {
HXLINE(  63)				_hx_tmp = ::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE(  63)				_hx_tmp = true;
            			}
HXDLIN(  63)			if (_hx_tmp) {
HXLINE(  63)				::openfl::utils::Assets_obj::getSound(EmbeddedSound,true);
            			}
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_71_browserLoad)
HXDLIN(  71)		::String prefix = HX_("",00,00,00,00);
HXDLIN(  71)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(site))) {
HXDLIN(  71)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN(  71)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + site)),HX_("_blank",95,26,d9,b0));
            	}
...
HXDLIN(  17)		difficultyStuff = ::cpp::VirtualArray_obj::__new(2)->init(0,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("Normal",47,e6,fd,64))->init(1,HX_("",00,00,00,00)))->init(1,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("Hard",0b,5b,e1,2f))->init(1,HX_("-hard",98,49,10,2e)));
            	}
}
