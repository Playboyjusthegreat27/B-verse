...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("81",f9,30,00,00));
...
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin B-verse!",1d,0e,0c,22));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin B-verse!",1d,0e,0c,22))
