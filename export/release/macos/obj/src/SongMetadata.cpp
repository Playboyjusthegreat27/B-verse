...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_401_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",401,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_401_new)
HXLINE( 406)		this->color = -7179779;
HXLINE( 405)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 404)		this->week = 0;
HXLINE( 403)		this->songName = HX_("",00,00,00,00);
HXLINE( 410)		this->songName = song;
HXLINE( 411)		this->week = week;
HXLINE( 412)		this->songCharacter = songCharacter;
HXLINE( 413)		if ((week < ::FreeplayState_obj::coolColors->length)) {
HXLINE( 414)			this->color = ::FreeplayState_obj::coolColors->__get(week);
            		}
            	}
