...
HXLINE(  74)		::String ourSource = HX_("assets/videos/DO NOT DELETE OR GAME WILL CRASH/dontDelete.webm",a4,1f,1a,38);
HXLINE(  86)		::String str1 = HX_("WEBM SHIT",e7,ff,8c,40);
HXLINE(  87)		 ::WebmHandler webmHandle =  ::WebmHandler_obj::__alloc( HX_CTX );
HXLINE(  88)		webmHandle->source(ourSource);
HXLINE(  89)		webmHandle->makePlayer();
HXLINE(  90)		webmHandle->webm->set_name(str1);
HXLINE(  91)		this->addChild(webmHandle->webm);
HXLINE(  92)		::GlobalVideo_obj::setWebm(webmHandle);
