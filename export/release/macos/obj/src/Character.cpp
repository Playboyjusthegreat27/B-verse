...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_202_update,"Character","update",0x0e18944e,"Character.update","Character.hx",202,0xf073a2d5)
...
HXLINE(  98)				::String path = (HX_("mods/",9e,2f,58,0c) + characterPath);
HXLINE(  99)				if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 100)					path = (HX_("assets/",4c,2a,dc,36) + characterPath);
            				}
HXLINE( 103)				if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 109)					path = (HX_("assets/",4c,2a,dc,36) + ((HX_("characters/",45,3c,bf,be) + ::Character_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2)));
            				}
...
HXDLIN( 120)					if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE( 120)						_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
...
HXDLIN( 122)					if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE( 122)						_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
...
HXDLIN( 141)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 141)					_hx_tmp = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
HXLINE( 141)					_hx_tmp = false;
            				}
HXDLIN( 141)				if (_hx_tmp) {
HXLINE( 142)					this->healthColorArray = ( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) );
            				}
HXLINE( 144)				this->set_antialiasing(!(this->noAntialiasing));
HXLINE( 145)				if (!(::ClientPrefs_obj::globalAntialiasing)) {
HXLINE( 145)					this->set_antialiasing(false);
            				}
HXLINE( 147)				this->animationsArray = ( (::Array< ::Dynamic>)(json->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXLINE( 148)				bool _hx_tmp1;
HXDLIN( 148)				if (::hx::IsNotNull( this->animationsArray )) {
HXLINE( 148)					_hx_tmp1 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 149)					int _g = 0;
HXDLIN( 149)					::Array< ::Dynamic> _g1 = this->animationsArray;
HXDLIN( 149)					while((_g < _g1->length)){
HXLINE( 149)						 ::Dynamic anim = _g1->__get(_g);
HXDLIN( 149)						_g = (_g + 1);
HXLINE( 150)						::String animAnim = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 151)						::String animName = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 152)						int animFps = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 153)						bool animLoop = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 154)						::Array< int > animIndices = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 155)						bool _hx_tmp;
HXDLIN( 155)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 155)							_hx_tmp = (animIndices->length > 0);
            						}
            						else {
HXLINE( 155)							_hx_tmp = false;
            						}
HXDLIN( 155)						if (_hx_tmp) {
HXLINE( 156)							this->animation->addByIndices(animAnim,animName,animIndices,HX_("",00,00,00,00),animFps,animLoop,null(),null());
            						}
            						else {
HXLINE( 158)							this->animation->addByPrefix(animAnim,animName,animFps,animLoop,null(),null());
            						}
HXLINE( 161)						bool _hx_tmp1;
HXDLIN( 161)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 161)							_hx_tmp1 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 161)							_hx_tmp1 = false;
            						}
HXDLIN( 161)						if (_hx_tmp1) {
HXLINE( 162)							this->addOffset(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1));
            						}
            					}
            				}
            				else {
HXLINE( 166)					this->quickAnimAdd(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f));
            				}
            			}
            		}
HXLINE( 170)		this->originalFlipX = this->flipX;
HXLINE( 172)		this->recalculateDanceIdle();
HXLINE( 173)		this->dance();
HXLINE( 175)		if (( (bool)(isPlayer) )) {
HXLINE( 177)			this->set_flipX(!(this->flipX));
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_202_update)
