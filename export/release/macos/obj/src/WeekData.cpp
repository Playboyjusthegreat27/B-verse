...
HXDLIN(   7)		songsNames = ::cpp::VirtualArray_obj::__new(7)->init(0,::cpp::VirtualArray_obj::__new(1)->init(0,HX_("Tutorial",be,4b,67,5c)))->init(1,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Bopeebo",90,29,16,da))->init(1,HX_("Fresh",4e,f6,b3,99))->init(2,HX_("Dad-Battle",fe,4d,ac,32)))->init(2,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Spookeez",2c,36,dd,4e))->init(1,HX_("South",ed,01,fa,13))->init(2,HX_("Monster",fa,7b,01,86)))->init(3,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Pico",05,15,31,35))->init(1,HX_("Philly-Nice",22,f2,31,13))->init(2,HX_("Blammed",76,2a,51,09)))->init(4,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Satin-Panties",be,dc,41,e6))->init(1,HX_("High",82,63,e7,2f))->init(2,HX_("Milf",f6,78,35,33)))->init(5,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Cocoa",e9,0c,83,dd))->init(1,HX_("Eggnog",81,78,4e,29))->init(2,HX_("Winter-Horrorland",9d,fd,2a,b7)))->init(6,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Senpai",5c,53,22,a0))->init(1,HX_("Roses",e4,db,91,80))->init(2,HX_("Thorns",bc,33,5c,c1)));
            	}
{
