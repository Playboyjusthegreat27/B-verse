...
HX_DEFINE_STACK_FRAME(_hx_pos_d9f8eb28e5bf4846_1803_new,"AttachedFlxText","new",0xa2babd8d,"AttachedFlxText.new","ChartingState.hx",1803,0xd9647851)
HX_LOCAL_STACK_FRAME(_hx_pos_d9f8eb28e5bf4846_1814_update,"AttachedFlxText","update",0xadaf52fc,"AttachedFlxText.update","ChartingState.hx",1814,0xd9647851)
...
void AttachedFlxText_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_d9f8eb28e5bf4846_1803_new)
HXLINE(1807)		this->yAdd = ((Float)0);
HXLINE(1806)		this->xAdd = ((Float)0);
HXLINE(1810)		super::__construct(X,Y,FieldWidth,Text,Size,EmbeddedFont);
            	}
...
void AttachedFlxText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_d9f8eb28e5bf4846_1814_update)
HXLINE(1815)		this->super::update(elapsed);
HXLINE(1817)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(1818)			this->setPosition((this->sprTracker->x + this->xAdd),(this->sprTracker->y + this->yAdd));
HXLINE(1819)			this->set_angle(this->sprTracker->angle);
HXLINE(1820)			this->set_alpha(this->sprTracker->alpha);
            		}
            	}
