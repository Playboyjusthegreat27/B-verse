...
HXDLIN( 157)		 ::DialogueBox _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 185)		if (( ( ::flixel::input::FlxBaseKeyList)(::flixel::FlxG_obj::keys->justPressed) )->get_ANY()) {
...
HXLINE( 202)							 ::flixel::FlxSprite fh = _gthis->box;
HXDLIN( 202)							fh->set_alpha((fh->alpha - ((Float)0.2)));
HXLINE( 203)							 ::flixel::FlxSprite fh1 = _gthis->bgFade;
HXDLIN( 203)							fh1->set_alpha((fh1->alpha - ((Float)0.139999999999999986)));
HXLINE( 204)							_gthis->portraitLeft->set_visible(false);
HXLINE( 205)							_gthis->portraitRight->set_visible(false);
HXLINE( 206)							 ::flixel::addons::text::FlxTypeText fh2 = _gthis->swagDialogue;
HXDLIN( 206)							fh2->set_alpha((fh2->alpha - ((Float)0.2)));
HXLINE( 207)							 ::flixel::FlxSprite fh3 = _gthis->handSelect;
HXDLIN( 207)							fh3->set_alpha((fh3->alpha - ((Float)0.2)));
...
HXDLIN( 238)		 ::DialogueBox _gthis = ::hx::ObjectPtr<OBJ_>(this);
