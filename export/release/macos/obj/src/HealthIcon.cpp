...
HXDLIN(  40)			if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  40)				_hx_tmp = true;
            			}
            			else {
HXLINE(  40)				if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key))) {
HXLINE(  40)					_hx_tmp = true;
            				}
            				else {
...
HXDLIN(  41)			if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key1,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  41)				_hx_tmp1 = true;
            			}
            			else {
HXLINE(  41)				if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1))) {
HXLINE(  41)					_hx_tmp1 = true;
            				}
            				else {
...
HXLINE(  45)			this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_4,3),0,false,this->isPlayer,null());
